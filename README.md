...
1. Activate your virtual environment: If you are using a virtual environment (recommended), activate it first. For example:
```
# On Windows
...
```
2. Generate the requirements.txt file: Use the following command:
```
